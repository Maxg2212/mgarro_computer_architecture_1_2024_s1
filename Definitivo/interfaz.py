...
# Definir botones
boton_convertir_1 = crear_boton(ventana, AZUL, 50, 50, 300, 50, "Introducir reverb", lambda: convertir_y_reproducir("output.bin", "audio_convertido_1.wav"))
boton_convertir_2 = crear_boton(ventana, VERDE, 50, 120, 300, 50, "Eliminar reverb", lambda: convertir_y_reproducir("outputsr.bin", "audio_convertido_2.wav"))
